...
public class PinceSatineFermeCommand extends Command {
    
    private XboxController mXboxController;
    private PinceSatineSubsystem mPinceSatineSubsystem;

    public PinceSatineFermeCommand(PinceSatineSubsystem PinceSatineSubsystem) { 
        mPinceSatineSubsystem = PinceSatineSubsystem;
        addRequirements(PinceSatineSubsystem);
    }
    
    public PinceSatineFermeCommand(PinceSatineSubsystem PinceSatineSubsystem, XboxController xboxController) { 
        mPinceSatineSubsystem = PinceSatineSubsystem;
    ...
    @Override
    public void execute() {
        mPinceSatineSubsystem.SatineFerme(1);
    }
