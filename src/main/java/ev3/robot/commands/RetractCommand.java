...
public class RetractCommand extends Command {
    ...
    public RetractCommand(ExtendSubsystem ExtendSubsystem) { 
        mExtendSubsystem = ExtendSubsystem;
        addRequirements(ExtendSubsystem);
    }
    
    public RetractCommand(ExtendSubsystem ExtendSubsystem, XboxController xboxController) { 
        mExtendSubsystem = ExtendSubsystem;
    ...
    public void initialize() { 
      mExtendSubsystem.SatineRetract(1);
    }
