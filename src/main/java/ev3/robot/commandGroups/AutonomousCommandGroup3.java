...
public class AutonomousCommandGroup3 extends SequentialCommandGroup {

    public AutonomousCommandGroup3(DriveSubsystem driveSubsystem) {
        ...
        DriveAutoCommand avancerNbr2 = new DriveAutoCommand(driveSubsystem, 1, 0, 50);
        GyroCommand tourner90Degre = new GyroCommand(driveSubsystem, 90);
        GyroCommand tournerMoins360Degre = new GyroCommand(driveSubsystem, 15);
